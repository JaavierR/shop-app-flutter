...
class Products with ChangeNotifier {
  ...
  // Method to find the product in product_detail_screen
  ...
  // Function to rebuild when I'm in ithe favorites screen and tap on the heart
  // to unfavorite the item.
  ...
  Future<void> fetchAndSetProducts([bool filterByUser = false]) async {
    ...
    try {
      ...
      url =
          'https://shop-app-d76fe.firebaseio.com/userFavorites/$userId.json?auth=$authToken';
  ...
  Future<void> deleteProduct(String id) async {
    ...
    // Optimistic update: we reinsert the product into the list if the http
    // request fails.
